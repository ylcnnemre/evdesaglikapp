...
import { addHastalikInfo, addSikayetInfo, editHastalikInfo, editSikayetInfo } from '../../redux/NewPatienReducer';
...
const HastaHastalik = () => {
    ...
    const [hastalikData, setHastalikData] = useState<{ id: string, title: string, desc: string }>({ id: "", desc: "", title: "" })
    ...
    const { hastalikList } = useSelector((item: IselectorType) => item.newPatient)
    useEffect(() => {
    ...
    const confirmModal = () => {
        ...
        if (!modalControl.editMode) {
            dispatch(addHastalikInfo({
                id: uuidv4(),
                desc: hastalikData.desc,
                title: hastalikData.title
            }))
            setHastalikData({
                id: "",
                desc: "",
                ...
                <Modal visible={modalControl.visible} onDismiss={hideModal} contentContainerStyle={style.modal} dismissable={false}  >
                    ...
                    <View style={style.modalHeader} >
                        <Text style={{ fontSize: 18 }}>
                            {
                                modalControl.editMode ? "Hastalık Düzenle" : "Hastalık Ekle"
                            }
                        </Text>
